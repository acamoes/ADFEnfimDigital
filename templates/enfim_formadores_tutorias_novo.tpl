                    ...
                    <form id="{$currentTab}Novo" name="{$currentTab}Novo"
                        ...
                        <div class="row uniform">
                            <div style="float: left">
                                <label for="name">Curso</label> <select name="idCourse"
                                    ...
                                    {foreach $formadores->requisitos as $requisito}
                                        <option  
                                            value="{$requisito['idCourse']}">{$curso['idCourse']}
                                        </option>
                                    {/foreach}
                                    ?>
                                </select>
                        ...
                        <div class="row uniform">
                            <div style="float: left">
                                ...
                                <input required type="text" name="Requisito" id="Requisito" style="width: 350px" />
                            </div>
                            {* <div style="float: right">
