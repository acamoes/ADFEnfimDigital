...
class EquipaExecutiva
{
    ...
    public function __construct($data)
    {
        ...
        $this->requisitos   = $this->getRequisitos($data);
    ...
    {
        $this->tabs = json_decode('{"tabs":[{"text":"Utilizadores","tab":"utilizadores"},{"text":"Cursos","tab":"cursos"},{"text":"Módulos","tab":"modulos"},{"text":"Requisitos","tab":"requisitos"},{"text":"Documentos","tab":"documentos"},{"text":"Calendários","tab":"calendarios"},{"text":"Formações","tab":"formacoes"},{"text":"Avaliações","tab":"avaliacoes"} ]}');
    }
    ...
    {
        return Requisitos::getRequisito($data);
    }

    public function getRequisitos($data)
    {
        return Requisitos::getRequisitos($data);
    }

    public function inserirRequisitos($data)
    {
        return Requisitos::inserirRequisitos($data);
    }

    public function apagarRequisitos($data): array
    {
        return Requisitos::apagarRequisitos($data);
    }

    public function atualizarRequisitos($data)
    {
        return Requisitos::atualizarRequisitos($data);
    }
